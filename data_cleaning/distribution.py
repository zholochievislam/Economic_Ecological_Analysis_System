...
for i in countries["Code"]:
    if countries["Code"].isnull().any() == False:
...
# EconDataID: '01', '02', '03', ...
econ_data["EconDataID"] = (econ_data.index + 1).astype(str).str.zfill(2)
